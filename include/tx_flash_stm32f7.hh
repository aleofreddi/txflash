#ifndef TX_FLASH_STM32F7_HH
#define TX_FLASH_STM32F7_HH
...
template<uint8_t Sector, uint32_t Address, uint32_t Length>
void Stm32f7FlashBank<Sector, Address, Length>::erase() {
    HAL_FLASH_Unlock();
...
template<uint8_t Sector, uint32_t Address, uint32_t Length>
void Stm32f7FlashBank<Sector, Address, Length>::read_chunk(size_t position, void *destination, size_t length) const {
    memcpy(destination, (char *) Address + position, length);
}

template<uint8_t Sector, uint32_t Address, uint32_t Length>
void Stm32f7FlashBank<Sector, Address, Length>::write_chunk(size_t position, const void *source, size_t length) {
